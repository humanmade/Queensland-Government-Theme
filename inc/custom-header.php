...
function qldgovt_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'qldgovt_custom_header_args', array(
		...
		'height'                 => 50,
		'flex-height'            => true,
		'wp-head-callback'       => 'qldgovt_header_style',
		'admin-head-callback'    => 'qldgovt_admin_header_style',
		'admin-preview-callback' => 'qldgovt_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'qldgovt_custom_header_setup' );

if ( ! function_exists( 'qldgovt_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog
	 *
	 * @see qldgovt_custom_header_setup().
	 */
	function qldgovt_header_style() {
...
if ( ! function_exists( 'qldgovt_admin_header_style' ) ) :
	 ...
	 * @see qldgovt_custom_header_setup().
	 */
	function qldgovt_admin_header_style() {
		?>
		<style type="text/css">
...
if ( ! function_exists( 'qldgovt_admin_header_image' ) ) :
	 ...
	 * @see qldgovt_custom_header_setup().
	 */
	function qldgovt_admin_header_image() {
		?>
		<div id="headimg">
