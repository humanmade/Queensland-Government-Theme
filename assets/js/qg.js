...
if (typeof(jQuery) != "undefined") {
	(function(c) {
		...
		c("#nav-section").click(function(d) {
			...
			switch (e) {
				case "+":
					f.nextAll("ul").stop(true, true).show().end().html('<img src="/Templates/cue/images/minus-flat.png" alt="[-]" /><span class="title">Close the ' + f.next().text() + " submenu</span>");
					return false;
				case "-":
					f.nextAll("ul").stop(true, true).hide().end().html('<img src="/Templates/cue/images/plus-flat.png" alt="[+]" /><span class="title">Open the ' + f.next().text() + " submenu</span>");
					return false
			}
		}).keypress(function(d) {
		...
		c("#nav-section ul a").filter(function() {
			...
			var d = c(this);
			d.prepend('<a href="#nav-section" class="qg-cue-widget"><img src="/Templates/cue/images/minus-flat.png" alt="[-]" /><span class="title">Close the ' + d.children("a").text() + " submenu</span></a>")
		});
		c("#nav-section li:not(.qg-cue-widget-container) ul").parent().addClass("qg-cue-widget-container").each(function() {
			var d = c(this);
			d.prepend('<a href="#nav-section" class="qg-cue-widget"><img src="/Templates/cue/images/plus-flat.png" alt="[+]" /><span class="title">Open the ' + d.children("a").text() + " submenu</span></a>")
		}).end().hide()
	})(jQuery)
}
if (typeof jQuery != "undefined") {
