                ...
                this.handles.each(function(n, m) {
                    ...
                    if (l.options.range === true) {
                        if (l.orientation === "horizontal") {
                            if (n === 0) {
                                l.range.stop(1, 1)[d ? "animate" : "css"]({
                                    left: g + "%"
                                }, e.animate)
                            }
                            if (n === 1) {
...
if (typeof jQuery == "undefined") {
    ...
    function playerReady(b) {
        ...
        a.fn.qgOvt = function(b) {
            ...
            b = (typeof b == "undefined") ? a.qg.ovt.defaultOptions : a.extend({}, a.qg.ovt.defaultOptions, b);
            success = true;
            a(this).each(function() {
                success = initQGVideoTemplate.apply(this, [b]) !== false ? success : false
            });
            return success
        };
        initQGVideoTemplate = function(b) {
            ...
            if (containerId == "" || a.inArray(containerId, a.qg.ovt.instances) !== -1) {
        ...
        parseVideoHTML = function(b) {
            ...
            if (typeof b.sourceflv != "undefined" && b.sourceflv != "") {
                ...
                if (typeof b.sourcemp4 != "undefined" && b.sourcemp4 != "") {
                    ...
                    flvLink = a(this).find("." + a.qg.ovt.conf.optionsClass + ' a[type*="video/flv"]');
                    mp4Link = a(this).find("." + a.qg.ovt.conf.optionsClass + ' a[type*="video/mp4"]');
                    if (flvLink.size() > 0) {
            ...
            b.ccfile = (typeof b.ccfile != "undefined" && b.ccfile != "") ? b.ccfile : (ccfile = a(this).find("." + a.qg.ovt.conf.optionsClass + " .captions a").get(0).href) + "" != "undefined" ? ccfile : "";
            if (b.ccfile == "") {
                consoleMessage("Video player warning: No captions file could be found (timed text xml)", "warn")
            }
            b.adfile = (typeof b.adfile != "undefined" && b.adfile != "") ? b.adfile : (adfile = a(this).find("." + a.qg.ovt.conf.optionsClass + " .audio-description a").get(0).href) + "" != "undefined" ? adfile : "";
            if (b.adfile == "") {
                consoleMessage("Video player notice: No audio description file could be found (mp3)", "notice")
            }
            b.poster = (typeof b.poster != "undefined" && b.poster != "") ? b.poster : (poster = a(this).find("." + a.qg.ovt.conf.posterClass).get(0).src) + "" != "undefined" ? poster + "" : "";
            if (b.poster == "") {
                consoleMessage("Video player notice: No poster image could be found (jpg, png)", "notice")
            }
            b.accessswf = (b.accessswf != "") ? b.accessswf : b.playerswf.substr(0, b.playerswf.lastIndexOf("/")) + "/accessibility.swf";
        ...
        decorateQGVideoTemplate = function(b) {
            embedCode = a.qg.ovt.conf.flashEmbedTemplate.replace(/{videoid}/g, b.videoid).replace(/{playerswf}/g, b.playerswf).replace(/{accessswf}/g, b.accessswf).replace(/{videofile}/g, b.videofile).replace(/{poster}/g, b.poster).replace(/{ccfile}/g, b.ccfile).replace(/{adfile}/g, b.adfile);
            embedElement = a('<div class="' + a.qg.ovt.conf.playerClass + '"></div>').append(embedCode + a.qg.ovt.conf.controlsTemplate);
            transcript = a('<div class="' + a.qg.ovt.conf.innerClass + '"></div>').append(a(this).find("." + a.qg.ovt.conf.transcriptClass).contents());
            downloadElement = a(this).find("." + a.qg.ovt.conf.optionsClass + " .download");
            ...
            a(this).find("." + a.qg.ovt.conf.optionsClass + " .download a").each(function() {
                linkText = a(this).text();
                a(this).attr("title", linkText).empty().append(linkText.replace(/(.*\(.*, )([a-z0-9]*?)( .*\))/i, "<span>$1</span>$2<span>$3</span>"))
            });
            a(this).find("." + a.qg.ovt.conf.posterClass).remove().end().find("." + a.qg.ovt.conf.optionsClass + " .captions").remove().end().find("." + a.qg.ovt.conf.optionsClass + " .audio-description").remove().end().find("." + a.qg.ovt.conf.altsClass).before(embedElement).find("ul." + a.qg.ovt.conf.optionsClass).append(a.qg.ovt.conf.transcriptLink).end().end().find("." + a.qg.ovt.conf.optionsClass + " .download ul li:last").addClass("last-child").end().find("." + a.qg.ovt.conf.transcriptClass).empty().append(transcript).hide().end().find("." + a.qg.ovt.conf.optionsClass + " a, ." + a.qg.ovt.conf.controlsClass + " a").focusClass().end().find(".qg-ovt-overlay").css({
                "z-index": 4
            }).end().removeClass(a.qg.ovt.conf.containerClass).addClass(a.qg.ovt.conf.activeClass);
        ...
        initVidControls = function(e) {
            ...
            e.find(".captions a").toggle(function() {
            ...
            e.find(".audio-description a").toggle(function() {
                var h = getVidContainer(this);
                var f = h.data("playerID");
                var g = document.getElementById(f);
                g.muteAudio(false);
            ...
            d.find(".transcript a").toggle(function() {
            ...
            if (a.ui && typeof a.ui.slider != "undefined") {
                e.find(".volume").append('<div class="volume-overlay"><div class="volume-slider"></div></div>').find(".volume-overlay").hide().find(".volume-slider").slider({
                    range: "min",
            ...
            e.find(".volume > a").click(function() {
                var h = getVidContainer(this);
                var f = h.data("playerID");
                var g = document.getElementById(f);
            ...
            if (a.ui && typeof a.ui.slider != "undefined") {
                e.find(".progress-bar").data("uimode", "read").slider({
                    range: "min",
                    start: function() {
            ...
            e.find(".progress-bar .ui-slider-range").after('<div class="load-progress"></div>')
        };
        ...
        updatePlayButton = function(c, b) {
            ...
            if (b || container.data("state") == "playing") {
                a(buttonEl).attr("title", a.qg.ovt.conf.pauseTitle).addClass("pressed").find(".span").text(a.qg.ovt.conf.pauseText)
            } else {
                a(buttonEl).attr("title", a.qg.ovt.conf.playTitle).removeClass("pressed").find(".span").text(a.qg.ovt.conf.playText)
            }
        };
        updateCCButton = function(c, b) {
            ...
            if (b) {
                a(buttonEl).find(".span").text(a.qg.ovt.conf.closeCCText).end().attr("title", a.qg.ovt.conf.closeCCTitle).addClass("pressed")
            } else {
                a(buttonEl).find(".span").text(a.qg.ovt.conf.openCCText).end().attr("title", a.qg.ovt.conf.openCCTitle).removeClass("pressed")
            }
        };
        updateADButton = function(c, b) {
            ...
            if (b) {
                a(buttonEl).find(".span").text(a.qg.ovt.conf.closeADText).end().attr("title", a.qg.ovt.conf.closeADTitle).addClass("pressed")
            } else {
                a(buttonEl).find(".span").text(a.qg.ovt.conf.openADText).end().attr("title", a.qg.ovt.conf.openADTitle).removeClass("pressed")
            }
        };
        updateTranscriptButton = function(c, b) {
            ...
            if (b) {
                a(buttonEl).text(a.qg.ovt.conf.closeTranText).attr("title", a.qg.ovt.conf.closeTranTitle).addClass("pressed")
            } else {
                a(buttonEl).text(a.qg.ovt.conf.openTranText).attr("title", a.qg.ovt.conf.openTranTitle).removeClass("pressed")
            }
        };
        ...
        updateVolumeButton = function(d, e) {
            ...
            a(buttonEl).attr("title", a.qg.ovt.conf.unpressedVolumeTitle).find(".span").text(a.qg.ovt.conf.volumeText).data("volume", e);
            buttonEl.removeClass("pressed vol-muted vol-low vol-medium vol-high");
            if (e == 0) {
                buttonEl.addClass("pressed").addClass("vol-muted").attr("title", a.qg.ovt.conf.pressedVolumeTitle)
            } else {
                if (e < 40) {
        ...
        updateDimensions = function(b, c) {
            a(b).css({
                width: c.width
            }).find(".qg-ovt-player-wrapper").css({
                width: c.width,
                height: c.height
            }).find("object").attr("width", c.width).attr("height", c.height);
        ...
        findVidPlayer = function(b) {
            return a(b).find("." + a.qg.ovt.conf.embeddedClass).get(0)
        };
